...
class ManterHorarioUI:
    ...
    def atualizar():
        ...
        if len(horarios) == 0: st.write("Nenhum horário cadastrado")
            ...
            servico = st.selectbox("Informe o novo serviço", servicos, next((i for i, s in enumerate(servicos) if
            s.get_id() == id_servico), None))
...
op
= st.selectbox("Exclusão de Horários", horarios)
